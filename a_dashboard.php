    ...
    <main>
      ...
      <div class="insights">
        ...
        <div class="sales">
          ...
          <small> 4 Doctors joined this week</small>
        </div>
        <!-- end seling -->
        <!-- start expenses -->
        <div class="expenses">
          ...
          <small> 8 Staffs on vaction</small>
        </div>
        <!-- end seling -->
        <!-- start seling -->
        <div class="income">
          ...
          <small>1780 New patients admitted</small>
        </div>
        <!-- end seling -->
      ...
      <div class="recent_order">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>Integration with IoT</td>
              <td>Neptune Technologies</td>
              <td>500$</td>
              <td class="warning">Pending</td>
              <td class="primary">Details</td>
            </tr>
            <tr>
              <td>Virtual Consultancy</td>
              <td>Virtual Visionaries</td>
              <td>800$</td>
              <td class="warning">Pending</td>
              <td class="primary">Details</td>
            </tr>
            ...
            <tr>
              <td>Telemedication</td>
              <td>E-Commerce Ninjas</td>
              <td>5000$</td>
              <td class="success">Completed</td>
              <td class="primary">Details</td>
            </tr>
