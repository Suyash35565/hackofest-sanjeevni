  ...
  <body>
    <div class="sidenav">
        <div class="login-main-text">
            <img   class="Avtar"  src="patient.png" alt="Patient Avtar">
           <h2>Patient's<br> Registration Page</h2>
           ...
           <div class="login-form">
            <h3>Registration Page</h3>
              ...
              <div class="form-group">
                ...
                <a href="patientloginpage.php" > <button type="submit" class="btn btn-success">Register</button></a> 
